...
echo "\n####################################Starting News####################################"
sudo docker run --name news-qa --net rocketstreets_network --ip 172.0.0.7 -d -p 5003:5003 dwipam/rocketstreets:news-qa-$1
...
sudo docker exec engine-qa python tickers.py
