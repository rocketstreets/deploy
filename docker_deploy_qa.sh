...
echo "\n####################################Starting Engine####################################"
sudo docker run --name engine-qa --env SMTP_PWD=$SMTP_PWD --env IS_QA=True --net rocketstreets_network --ip 172.0.0.6 -d -p 5001:5001 dwipam/rocketstreets:engine-qa-$1
